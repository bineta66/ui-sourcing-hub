...
const navItems = [
  { id: 'dashboard', label: 'Dashboard', icon: 'fa-solid fa-chart-pie', to: 'offres' },
  { id: 'entretien', label: 'Entretien', icon: 'fa-regular fa-calendar-check', to: 'dash' },
  { id: 'candidates', label: 'Candidates', icon: 'fa-solid fa-user-group' },
  { id: 'campagnes', label: 'Campagnes', icon: 'fa-solid fa-file-lines' },
  { id: 'utilisateurs', label: 'Utilisateurs', icon: 'fa-solid fa-users' },
  { id: 'ai-analytics', label: 'AI Analytics', icon: 'fa-solid fa-brain' },
