...
onMounted(async () => {
  questions.value = await getQuestionsByType('technique')
  loading.value = false
})
...
async function terminerEntretien() {
  ...
  store.markEntretienComplete(route.params.entretienId, route.params.candidatId, 'technique')
